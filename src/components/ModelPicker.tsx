...
export function ModelPicker(t0) {
  ...
  const t16 = headerText ?? "Switch between models from the current provider. Applies to this session and future my-code sessions. For other/previous model names, specify with --model.";
  let t17;
  if ($[42] !== t16) {
