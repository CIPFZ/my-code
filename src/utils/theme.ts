...
const lightTheme: Theme = {
  ...
  startupAccent: 'rgb(124,176,133)', // MyCode pastel green
  ...
  userMessageBackgroundHover: 'rgb(252, 252, 252)', // â‰?50 to quantize distinct from base at 256-color level
...
const lightDaltonizedTheme: Theme = {
  ...
  userMessageBackgroundHover: 'rgb(232, 232, 232)', // â‰?30 to quantize distinct from base at 256-color level
...
const darkTheme: Theme = {
  ...
  claude: 'rgb(215,119,87)', // Claude orange
  startupAccent: 'rgb(184,225,174)', // MyCode pastel green
